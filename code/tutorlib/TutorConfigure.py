...
class TutorialDirectoryPrompt(Toplevel):
    def __init__(self, master):
        ...
        Button(tut_frame, text='Select',
               command=self.select_tut_dir).pack(side=LEFT, padx=10)
        ...
        Button(ans_frame, text='Select',
               command=self.select_ans_dir).pack(side=LEFT, padx=10)
